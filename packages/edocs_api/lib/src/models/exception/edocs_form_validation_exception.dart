class edocsFormValidationException implements Exception {
  final Map<String, String> validationMessages;

  edocsFormValidationException(this.validationMessages);
  ...
  factory edocsFormValidationException.fromJson(Map<String, dynamic> json) {
    final Map<String, String> validationMessages = {};
    ...
    return edocsFormValidationException(validationMessages);
  }
}
