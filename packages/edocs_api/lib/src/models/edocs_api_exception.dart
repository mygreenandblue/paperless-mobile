class EdocsApiException implements Exception {
  final ErrorCode code;
  final String? details;
  final StackTrace? stackTrace;
  final int? httpStatusCode;

  const EdocsApiException(
    this.code, {
    this.details,
    this.stackTrace,
    this.httpStatusCode,
  ...
  @override
  String toString() {
    return "edocsServerException(code: $code${stackTrace != null ? ', stackTrace: ${stackTrace.toString()}' : ''}${httpStatusCode != null ? ', httpStatusCode: $httpStatusCode' : ''})";
  }
}
